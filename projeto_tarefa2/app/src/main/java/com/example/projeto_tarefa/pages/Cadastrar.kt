...
@Composable
fun Cadastrar(auth: FirebaseAuth, navController: NavHostController, innerPadding: PaddingValues){
    ...
    Column(
        ...
        Row(
            ...
            TextButton(onClick = {
                ...
                Text("Logar-se", fontSize = 20.sp)
            }
        }

        Text("Cadastrar-se", fontSize = 35.sp)
